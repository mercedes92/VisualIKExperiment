...
class Auxiliar(QtGui.QDialog,Ice.Application):
	...
	def runTest(self):
		...
		self.init_value_R = ((15.0*math.pi)/180.)/10#0.0
		self.end_value_T  = 20.00
		self.end_value_R  = (12.0*math.pi)/180.0#0.0
		self.step_value_T = 5
		self.step_value_R = ((15.0*math.pi)/180.)/10 #self.end_value_R/10.0
		self.i = 6 #change to 1
